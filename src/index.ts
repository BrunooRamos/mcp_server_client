...
class GoogleMapsServer extends MCPServer {
    ...
    async maps_geocode(address: string): Promise<any> {
    ...
    async maps_reverse_geocode(latitude: number, longitude: number): Promise<any> {
    ...
    async maps_search_places(query: string, location?: { latitude: number; longitude: number }, radius?: number): Promise<any> {
    ...
    async maps_place_details(place_id: string): Promise<any> {
    ...
    async maps_distance_matrix(origins: string[], destinations: string[], mode: string = 'driving'): Promise<any> {
    ...
    async maps_elevation(locations: Array<{ latitude: number; longitude: number }>): Promise<any> {
        ...
        return result.results.map((elevation: any) => ({
    ...
    async maps_directions(origin: string, destination: string, mode: string = 'driving'): Promise<any> {
